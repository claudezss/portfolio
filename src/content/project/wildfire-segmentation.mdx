...
video: "https://youtu.be/tZHpA-W5wZ8?si=1U-XPjin8t-v3H40"
video_title: "How U of T's ECE Students are using satellite images to detect wildfires"
---

import { YouTube } from 'astro-embed';

<YouTube id="https://youtu.be/tZHpA-W5wZ8?si=1U-XPjin8t-v3H40" posterQuality="max" title="How U of T's ECE Students are using satellite images to detect wildfires" />
